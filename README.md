...
Compose independent instructions and estimate whether they can land atomically in v1.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. Atomic Batch Builder explores a focused consumer use of that space while making the wire budget visible.
